...
def trigger_github_workflow(**context):
    ...
    workflow_url = "https://api.github.com/repos/USERNAME/REPONAME/actions/workflows/WORKFLOWNAME/dispatches"
...
with DAG(
    ...
    # upload_task = BashOperator(task_id="gcs_upload",
    #                            bash_command="gcloud storage cp FILE_PATH gs://{{ params.GCS_BUCKET_NAME }}",
    #                            params={"GCS_BUCKET_NAME": "BUCKET_NAME"}
    #                           )
